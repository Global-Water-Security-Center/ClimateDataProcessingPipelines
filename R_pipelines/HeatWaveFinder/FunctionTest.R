...
#you  need arrow to run the function and ggplot2 to plot the outputs like I did here
#if you don't have these packages, install them using install.packages(c("arrow","ggplot2")
library(arrow)
library(ggplot2)
...
#the function returns a dataframe with column headers x, y, and count. x and y are the locations in your initial dataset
#count is the number of days that that location was in a heatwave during your time period of interest
